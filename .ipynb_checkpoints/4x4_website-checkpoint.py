...
img22= Image.open('images/22.jpg') 
img23= Image.open('images/23.jpg')
img24= Image.open('images/24.jpg')
...
with st.container():
    st.write('---')
    st.header('Disassembly and Designing Processes')
    st.write('##')
    image_column01 , image_column02, image_column03 = st.columns(3)
...
with st.container():
    st.write('---')
    st.header('Drivability Road Tests')
    st.write('##')
    image_column01 , image_column02, image_column03 = st.columns(3)
...
with st.container():
    st.write('---')
    st.header('AAD 2018 - Africa Aerospace and Defence Exhibition South Africa 2018')
    st.write('##')
    image_column01 , image_column02, image_column03 = st.columns(3)
